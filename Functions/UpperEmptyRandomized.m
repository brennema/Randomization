function [combined_all]=UpperEmptyRandomized(lower,upper,lower_rand,lower_yoga,lower_medit,lower_streng,upper_yoga,upper_medit,upper_streng,randomized,blockNum)
